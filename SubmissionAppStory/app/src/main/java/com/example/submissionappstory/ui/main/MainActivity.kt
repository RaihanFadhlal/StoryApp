...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        logResViewModel = ViewModelProvider(this, ViewModelFactory(tokenPref, accountRepo, this))[LogResViewModel::class.java]

        pageModel = ViewModelProvider(this, ViewModelFactory(tokenPref, accountRepo, this))[PageModel::class.java]
